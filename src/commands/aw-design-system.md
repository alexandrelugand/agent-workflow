...
allowed-tools:
  ...
  - AskUserQuestion
---
# aw-design-system — Global design system capture
...
### Step 3 — Write
Write docs/design-system.md and commit it on the default branch (docs: design system). It is the project's single visual reference, read by /aw-design at every story.

End with: "Design system captured in docs/design-system.md. Story screens will build on it via /aw-design <story>."
