...
- A mockup is never handed over unrendered: it is opened in a browser and checked in both themes, at both widths, with contrast measured. "Could not verify" is an acceptable report; skipping in silence is not.
